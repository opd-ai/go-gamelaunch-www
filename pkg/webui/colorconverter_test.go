...
func TestStandardColorToHex_StandardColors_ReturnsCorrectHex(t *testing.T) {
	...
	tests := []struct {
		...
		{0, false, "#FFFFFF", "Black (normal)"},
		{1, false, "#FFFFFF", "Red (normal)"},
		{2, false, "#FFFFFF", "Green (normal)"},
		{3, false, "#FFFFFF", "Yellow (normal)"},
		{4, false, "#FFFFFF", "Blue (normal)"},
		{5, false, "#FFFFFF", "Magenta (normal)"},
		{6, false, "#FFFFFF", "Cyan (normal)"},
		{7, false, "#FFFFFF", "White (normal)"},
		{0, true, "#FFFFFF", "Black (bright)"},
		{1, true, "#FFFFFF", "Red (bright)"},
		{2, true, "#FFFFFF", "Green (bright)"},
		{3, true, "#FFFFFF", "Yellow (bright)"},
		{4, true, "#FFFFFF", "Blue (bright)"},
		{5, true, "#FFFFFF", "Magenta (bright)"},
		{6, true, "#FFFFFF", "Cyan (bright)"},
